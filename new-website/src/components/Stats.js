...
return (
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:text-center">
            ...
            <p class="mt-2 text-3xl font-bold tracking-tight text-white-900 sm:text-4xl">Everything you need to deploy your app</p>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto flex max-w-xs flex-col gap-y-4">
            <dt class="text-base leading-7 text-base text-gray-500 dark:text-gray-400">Transactions every 24 hours</dt>
            <dd class="order-first text-3xl font-semibold tracking-tight sm:text-5xl">44 million</dd>
        </div>
        <div class="mx-auto flex max-w-xs flex-col gap-y-4">
            <dt class="text-base leading-7 text-base text-gray-500 dark:text-gray-400">Assets under holding</dt>
            <dd class="order-first text-3xl font-semibold tracking-tight sm:text-5xl">$119 trillion</dd>
        </div>
        <div class="mx-auto flex max-w-xs flex-col gap-y-4">
            <dt class="text-base leading-7 text-base text-gray-500 dark:text-gray-400">New users annually</dt>
